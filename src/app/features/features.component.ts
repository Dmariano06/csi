...
others=[{name:'Title', name1:'description',img:"assets/img/illustrations/features4.png"},{name:'Title', name1:'description',img:"assets/img/illustrations/features5.png"},{name:'Title', name1:'description',img:"assets/img/illustrations/features6.png"}]
